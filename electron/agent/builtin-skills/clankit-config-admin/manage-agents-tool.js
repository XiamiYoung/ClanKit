...
class ManageAgentsTool extends BaseTool {
  ...
  async execute(toolCallId, input) {
    ...
    try {
      switch (action) {
        case 'create_agent':    return this._createAgent(input.agent)
        case 'update_agent':    return this._updateAgent(input.agent)
