...
// The ipcWindow module is required later after paths are initialized; we forward-declare here.
...
// --- IPC: Plaza (extracted to ipc/plaza.js) ----------------------------------
require('./ipc/plaza').register()
...
// --- IPC: Memory (extracted to ipc/memory.js) --------------------------------
// NOTE: memory:* handlers are registered later (after runMemoryExtraction is defined)
//       via require('./ipc/memory').register({ ... })
...
// --- IPC: Skills (extracted to ipc/skills.js) ---------------------------------
...
require('./ipc/memory').register({ lastExtractedMsgCount, pendingMemoryFacts, runMemoryExtraction })
...
// --- IPC: File Attachments — extracted to ipc/files.js -----------------------
const ipcFiles = require('./ipc/files')
ipcFiles.register()
// Re-export helpers used by remaining handlers (knowledge, obsidian)
const IS_WSL = ipcFiles.IS_WSL
const toWslPath = ipcFiles.toWslPath
const readAttachment = ipcFiles.readAttachment
const showWindowsFilePicker = ipcFiles.showWindowsFilePicker
// Guard: prevent concurrent file/folder picker dialogs (for remaining knowledge/obsidian handlers)
...
// clipboard:get-image — extracted to ipc/files.js
...
// Window/shell IPC handlers — extracted to ipc/window.js
const ipcWindow = require('./ipc/window')
ipcWindow.register()

// Voice IPC handlers — extracted to ipc/voice.js
require('./ipc/voice').register()
