...
contextBridge.exposeInMainWorld('electronAPI', {
  ...
  agentImport: {
    ...
    regenerateUserIdentityCard: (params) => ipcRenderer.invoke('agent:regenerate-user-identity-card', params),
  ...
  updater: {
    ...
    installOnQuit:       ()     => ipcRenderer.invoke('updater:install-on-quit'),
    ...
    onInstallScheduled:  (cb)   => { const h=(_e,d)=>cb(d); ipcRenderer.on('updater:install_scheduled', h); return () => ipcRenderer.removeListener('updater:install_scheduled', h) },
