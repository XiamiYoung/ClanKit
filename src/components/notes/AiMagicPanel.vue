      ...
      <div ref="conversationRef" class="ai-magic-conversation" @scroll="onConversationScroll">
        ...
        >
          ...
          <div v-else class="ai-magic-bubble-ai">
            <div
              v-if="msg._useGeneratedLabel && !msg.content"
              class="ai-magic-ai-content ai-magic-ai-content--label"
            >{{ t('notes.editGenerated') }}</div>
            <div v-else class="ai-magic-ai-content" v-html="renderAiContent(msg.content)"></div>
...
.ai-magic-ai-content--label { color: #9CA3AF; font-style: italic; font-size: var(--fs-small); }
