...
const emit = defineEmits(['update:gridCount', 'update:gridChatIds', 'exit-grid', 'new-chat', 'select-chat', 'swap-chat', 'maximize-chat', 'open-chat-settings', 'open-body-viewer', 'remove-group-agent', 'start-call'])
