    ...
    <Teleport to="body">
      ...
      <div v-if="showHelpPopover" class="help-popover" :style="helpPopoverStyle">
        <div class="help-popover-header">
          <img :src="appIconUrl" :alt="t('app.name')" style="width:2rem;height:2rem;border-radius:0.5rem;" />
          <div style="flex:1;">
            <div style="font-weight:700;font-size:0.875rem;color:#1A1A1A;">{{ t('app.name') }}</div>
