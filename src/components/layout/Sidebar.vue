<template>
  ...
  >
    ...
    <!-- Help / About button in title bar — opens the About dialog directly,
         which now bundles app info (icon/name/version/platform) + the full
         privacy / terms text in a single scrollable dialog. -->
