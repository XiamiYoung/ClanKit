            ...
            <div v-if="ccmActiveTab === 'general'" class="ccm-tab-content">
              ...
              <div class="ccm-dark-section">
                ...
                <div class="ccm-stepper-row">
                  ...
                  <input
                    v-model.number="draftMaxAgentRounds"
                    type="number"
                    min="1"
                    max="100"
                    class="ccm-stepper-input"
                    @blur="draftMaxAgentRounds = Math.min(100, Math.max(1, Number(draftMaxAgentRounds) || 10))"
                  />
      ...
      <div class="ncp-dialog">
        ...
        <div class="ncp-list">
          ...
          <template v-if="newChatAgentSearch.trim()">
            ...
            >
              <div class="ncp-check">
                <input type="checkbox" :checked="newChatAgentIds.includes(p.id)" @change="toggleNewChatAgent(p.id)" />
...
// Agent header tooltip moved to ChatHeader (has its own tooltip state)
...
// flushSegments for group chat needs to find message by routeKey (chatId:agentId)
